...
<div class="intro">
    ...
    <div class="intro-text">
        ...
        <p>À Le Mans Université, nous nous engageons à réduire notre impact environnemental en favorisant le recyclage,
            la réutilisation et la gestion durable des ressources.
            <br>
            Grâce à ÉcoGestUM, notre application dédiée, nous mettons en place des solutions innovantes pour optimiser
            le tri, encourager la réutilisation des objets et sensibiliser notre communauté universitaire aux enjeux
            écologiques.
        </p>
    </div>
</div>
...
<section>
    <h2>Objectifs de la Politique de Recyclages</h2>
    <div class="vertical-box">
        <h3>Optimiser le Tri et le Recyclage</h3>
        <ul>
            <li>ÉcoGestUM permet de trier et recycler efficacement les équipements en fin de vie (meubles, matériel
                informatique, livres, etc.).</li>
            <li>Chaque objet recyclé est tracé pour garantir une gestion transparente et responsable.</li>
            <li>Objectif : Réduire les déchets envoyés en décharge de 30 % d'ici 2027.</li>
        </ul>
    </div>
</section>
...
<section>
    <h2>Faciliter l'Accès aux Dispositifs de Recyclage</h2>
        <div class="horizontal-box">
            <div class="vertical-box">
                <h3>Points de Collecte Accessibles</h3>
                <div class="horizontal-box">
    ...
    <div class="horizontal-box">
        <div class="vertical-box">
            ...
            <ul>
                ...
                <li>Consultez les statistiques et rapports pour suivre l'impact collectif.</li>
            </ul>
        </div>
        <div class="vertical-box">
...
<div class="conclusion-section">
    <h3>Conclusion</h3>
    <p>
        Chez Le Mans Université, nous croyons que chaque petite action compte. Grâce à EcoGestUM, nous rendons tout
        un
        chacun acteur de l'économie circulaire. Ensemble, recyclons, réutilisons et construisons un avenir plus
        durable
